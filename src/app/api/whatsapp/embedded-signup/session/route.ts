...
import { createEmbeddedSignupState, EMBEDDED_SIGNUP_STATE_COOKIE } from "@/modules/whatsapp/security/embeddedSignupState";
...
export async function POST() {
  ...
  try {
    ...
    response.cookies.set(EMBEDDED_SIGNUP_STATE_COOKIE, state, { httpOnly: true, sameSite: "lax", secure: process.env.NODE_ENV === "production", path: "/api/whatsapp/embedded-signup", maxAge: 600 });
    return response;
