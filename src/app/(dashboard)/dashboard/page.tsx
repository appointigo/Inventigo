...
const DashboardPage = () => {
  ...
  return (
    <div style={{ padding: 24, background: "#f9fafb", minHeight: "100%" }}>
      ...
      <div className="dashboard-chart-grid" style={{ display: "grid", gap: 12, marginBottom: 12 }}>
          ...
          {chartLoading ? (
            ...
            <ResponsiveContainer width="100%" height={280}>
              <BarChart layout="vertical" data={topBrands} margin={{ top: 8, right: 12, left: 12, bottom: 8 }}>
                ...
                <Tooltip formatter={(value: number) => formatCurrency(Number(value))} labelStyle={{ fontSize: 11, color: "#6b7280" }} contentStyle={{ borderRadius: 8, border: "0.5px solid #e5e7eb" }} />
          ...
          {chartLoading ? (
            ...
            <ResponsiveContainer width="100%" height={280}>
              <BarChart data={data?.stockByCategory ?? []} margin={{ top: 8, right: 12, left: 0, bottom: 8 }}>
                ...
                <Tooltip formatter={(value: number) => formatCurrency(Number(value))} contentStyle={{ borderRadius: 8, border: "0.5px solid #e5e7eb" }} />
      ...
      <div className="dashboard-table-grid" style={{ display: "grid", gap: 12 }}>
